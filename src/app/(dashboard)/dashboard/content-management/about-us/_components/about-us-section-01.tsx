...
export default function AboutUsSection01() {
  ...
  const handleSave = () => {
    console.log("Saving feature form data:", {
      title: (document.getElementById("feature-title") as HTMLInputElement)?.value,
      subtitle: (document.getElementById("feature-subtitle") as HTMLTextAreaElement)?.value,
      image: selectedFile,
    })
    alert("Feature form data saved! (Check console for details)")
  }
    ...
    <section className="px-6 py-2">
      <div className="mx-auto bg-white border-gray-200 border rounded-xl p-8 shadow-sm">
        ...
        <div className="space-y-6">
          {/* Title Input */}
          <div>
            <Label htmlFor="feature-title" className="text-base font-medium text-gray-800 mb-2 block">
              Title
            </Label>
            <Input
              id="feature-title"
          ...
          {/* Subtitle Textarea */}
          <div>
            <Label htmlFor="feature-subtitle" className="text-base font-medium text-gray-800 mb-2 block">
              Subtitle
            </Label>
            <Textarea
              id="feature-subtitle"
          ...
          {/* Upload Image */}
          <div>
            <Label htmlFor="feature-upload-image" className="text-base font-medium text-gray-800 mb-2 block">
              Upload Image
            </Label>
            <div
              ...
              onDrop={handleDrop}
              onClick={() => document.getElementById("feature-file-input")?.click()}
            >
