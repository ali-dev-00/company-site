...
const uploadSlots = ["img0", "img1", "img2", "img3", "img4", "img5"] as const
type UploadSlot = typeof uploadSlots[number]

export default function LifeAtGCContentSection04() {
  ...
  const fileInputRefs: Record<UploadSlot, React.RefObject<HTMLInputElement | null>> = {
    img0: useRef<HTMLInputElement | null>(null),
    img1: useRef<HTMLInputElement | null>(null),
    img2: useRef<HTMLInputElement | null>(null),
    img3: useRef<HTMLInputElement | null>(null),
    img4: useRef<HTMLInputElement | null>(null),
    img5: useRef<HTMLInputElement | null>(null),
  }
  ...
  const handleSave = () => {
    console.log("Saving LifeAtGCContentSection04:", { formData, selectedFiles })
