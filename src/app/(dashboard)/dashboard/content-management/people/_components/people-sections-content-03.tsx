...
export default function PeopleSectionContent03() {
  ...
  const handleSave = () => {
    console.log("Saving form data:", { formData, selectedFiles })
  ...
  return (
    <section className="px-6 py-2">
      <div className="border-gray-200 border mx-auto bg-white p-8 rounded-xl shadow-sm">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">3-Section</h2>
