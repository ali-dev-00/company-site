...
export default function ContactUsContentForm() {
  ...
  const handleSave = () => {
    console.log("Saving contact form data:", {
      title: (document.getElementById("contact-title") as HTMLInputElement)?.value,
      subtitle: (document.getElementById("contact-subtitle") as HTMLTextAreaElement)?.value,
      buttonText: (document.getElementById("contact-button-text") as HTMLInputElement)?.value,
      image: selectedFile,
    })
    alert("Contact form data saved! (Check console for details)")
  }
    ...
    <section className="px-6 py-2">
      <div className="border-gray-200 border mx-auto bg-white p-8 rounded-xl shadow-sm">
        ...
        <div className="space-y-6 ">
          {/* Title Input */}
          <div>
            <Label htmlFor="contact-title" className="text-base font-medium text-gray-800 mb-2 block">
              Title
            </Label>
            <Input
              id="contact-title"
          ...
          {/* Subtitle Textarea */}
          <div>
            <Label htmlFor="contact-subtitle" className="text-base font-medium text-gray-800 mb-2 block">
              Subtitle
            </Label>
            <Textarea
              id="contact-subtitle"
          ...
          {/* Button Text Input */}
          <div>
            <Label htmlFor="contact-button-text" className="text-base font-medium text-gray-800 mb-2 block">
              Button Text
            </Label>
            <Input
          ...
          {/* Upload Image */}
          <div>
            <Label htmlFor="contact-upload-image" className="text-base font-medium text-gray-800 mb-2 block">
              Upload Image
            </Label>
            <div
