...
type UploadSlot = "card0" | "card1" | "card2" | "card3"
type CardField = "title" | "subtitle" | "buttonText" | "buttonLink"

export default function InternationalSectionContent() {
  const [cards, setCards] = useState<CardData[]>([
    { id: 1, title: "", subtitle: "", buttonText: "", buttonLink: "" },
    { id: 2, title: "", subtitle: "", buttonText: "", buttonLink: "" },
    { id: 3, title: "", subtitle: "", buttonText: "", buttonLink: "" },
    { id: 4, title: "", subtitle: "", buttonText: "", buttonLink: "" },
  ])
  ...
  const fileInputRefs: Record<UploadSlot, React.RefObject<HTMLInputElement | null>> = {
    ...
    card2: useRef<HTMLInputElement | null>(null),
    card3: useRef<HTMLInputElement | null>(null),
  }
  ...
  const handleSave = () => {
    console.log("Saving card data:", { cards, selectedFiles })
      ...
      <div className="border-gray-200 border mx-auto bg-white p-8 rounded-xl shadow-sm">
        ...
        <div className="space-y-6">
          {cards.map((card, index) => (
            <div key={card.id} className={`space-y-4 ${index > 0 ? "pt-6 border-t border-gray-200" : ""}`}>
              <div>
