...
const newsArticles: NewsArticle[] = [
    {
        ...
        category: "News",
        title: "The Horumarka Dadka shortlisted for THREE commsHERO Awards",
        description: "The Horumarka Dadka and Marketing Manchester have been shortlisted for THREE commsHERO Awards.",
    ...
    },
    {
        ...
        category: "News",
        title: "Tehseen Ali Joins the Horumarka Dadka Board",
        description: "The Horumarka Dadka is pleased to announce the appointment of Tehseen Ali to its Board of Directors.",
    ...
    },
    {
        ...
        description:
            "The Horumarka Dadka is working with partners to help businesses navigate the impact of US tariff announcements.",
    ...
    },
    {
        ...
        description:
            "The Horumarka Dadka has joined leading employers across Greater Manchester to offer T Level placements - and is urging other businesses to follow their lead.",
    ...
    },
    {
        ...
        description:
            "We have 19 colleagues who are completing apprenticeship programmes alongside their roles here at the Horumarka Dadka to enhance their skills and professional development. National Apprenticeship Week we're sharing some of their experiences.",
        ...
        <section className="pb-16 pt-8 bg-white">
            <div className="max-w-[1366px] mx-auto px-4 md:px-8 lg:px-16">
                ...
                <div className="flex justify-center items-center space-x-2">
                    <button className="px-4 py-2 bg-black text-white  font-medium">1</button>
