                    ...
                    <div className="w-full relative overflow-hidden border-t-4  bg-red-600/80 bg-opacity-95 px-4 py-8 sm:px-6 sm:py-10 md:px-12 md:py-14 lg:px-24 lg:py-16 xl:px-28 xl:py-16">
                        <div className="relative max-w-full sm:max-w-4xl lg:max-w-5xl">
                            ...
                            <p className="text-sm text-white mb-4 font-medium sm:text-base sm:mb-5 md:mb-6 ">
                                Our journey began in Manchester 35 years ago. Since then, we&apos;ve helped to generate hundreds of millions of
                                pounds of investment, helped to upskill and place hundreds of thousands of people into work or progress their
                                careers, whilst working with tens of thousands of businesses to start, grow, internationalise and become more
