      ...
      <div className="relative flex max-w-[1366px] mx-auto  gap-10 sm:gap-0   flex-col lg:flex-row min-h-[400px] ">
        ...
        <div className="relative w-full lg:w-1/2 bg-[#FF2424]  text-white py-12 px-4 md:px-8 lg:px-16 flex items-center ">
          ...
          <div className="relative z-10 max-w-md text-left">
            ...
            <p className="text-md">
              Horumarka Dadka is committed to protecting your privacy. This Privacy Policy outlines how we collect, use, store, and safeguard your personal information when you engage with our website, training programs, or communication platforms.
              lives.
            </p>
          </div>
