          ...
          <div className="w-full relative overflow-hidden  border-t-4  bg-red-600/80 bg-opacity-95 px-4 py-8 sm:px-6 sm:py-10 md:px-12 md:py-14 lg:px-24 lg:py-16 xl:px-28 xl:py-16">
            <div className="relative max-w-full sm:max-w-4xl lg:max-w-5xl">
              ...
              <p className="text-sm text-white mb-4 font-medium sm:text-base sm:mb-5 md:mb-6 ">
                We began with a basic principle: that knowledge of practical
                applications is the key to both individual and collective
                growth. The creation of Horumarka Dadka in Hargeisa was driven
                by the urgent need for accessible and high-quality vocational
                training in Somaliland and the broader East Africa. From the
                very start we have helped thousands of people get accredited
                certifications to work for or advance in their careers.We have
                partnered with hundreds of businesses, government ministries and
                other NGOs in an effort to train their employees better, provide
                better services and promote sustainable and safer practices.
              </p>
            </div>
