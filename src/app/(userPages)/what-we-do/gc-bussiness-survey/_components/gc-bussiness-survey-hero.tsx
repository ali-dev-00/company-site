...
export default function GCBussinessSureveyPage() {
    return (
                ...
                <div className="absolute z-10 -bottom-43 px-4 md:px-8 lg:px-16 inset-0 flex items-end mx-auto ">
                    <div className="w-full relative overflow-hidden border-t-4  bg-red-600/80 bg-opacity-95 px-4 py-8 sm:px-6 sm:py-10 md:px-12 md:py-14 lg:px-24 lg:py-16 xl:px-28 xl:py-16">
                        <div className="relative maax-w-full sm:max-w-4xl lg:max-w-5xl">
                            ...
                            {/* Decorative Line */}
                            <div className="relative w-full max-w-80 h-1 mb-6 sm:mb-7 md:mb-8">
                            ...
                            <p className="text-sm text-white mb-4 font-medium sm:text-base sm:mb-5 md:mb-6 ">
                                The full GC Situation Report contains detailed data on the economy, and results of the GC Survey and Business Confidence Index. It
                                also provides headline data for local authorities in Greater Manchester.
                            </p>
                            <p className="text-sm text-white mb-4 font-medium sm:text-base sm:mb-5 md:mb-6 ">
                                Download the latest full GC Situation Report <span className="text-black font-medium" >here</span>
                            </p>
                            <p className="text-sm text-white mb-4 font-medium sm:text-base sm:mb-5 md:mb-6 ">
                                Download the report infographic <span className="text-black font-medium" >here</span>
                            </p>
                        </div>
