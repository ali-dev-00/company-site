...
const WhatWeDoPage = () => {
  return (
    <>
      ...
      <WhatWeDoHero />
      <ParagraphSection para1="We are a leading provider of impact-driven training programs, providing the right solutions across various specialisms for public, private, and third-sector clients." />
      <OurServicesGrid />
      <ContactUsBanner />
    </>
  );
